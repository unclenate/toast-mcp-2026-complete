...
| M2 | Read-only mode env flag (`TOAST_READ_ONLY=true` default) gates all 21 write tools at `src/server.ts:77-98` | 2026-06-15 | in progress (ADR-0002 accepted 2026-05-29; implementation pending) | Track 3 |
